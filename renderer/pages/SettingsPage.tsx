...
import { SeedingSection } from './settings/SeedingSection';
...
const SettingsPage: React.FC = () => {
  ...
  function renderSeedingSettings() {
    return (
      <SeedingSection
        renderSettingItem={renderSettingItem}
        defaultSeedRatioLimit={defaultSeedRatioLimit}
        setDefaultSeedRatioLimit={setDefaultSeedRatioLimit}
        defaultSeedTimeLimitMinutes={defaultSeedTimeLimitMinutes}
        setDefaultSeedTimeLimitMinutes={setDefaultSeedTimeLimitMinutes}
      />
    );
  }
  ...
  function renderAboutSettings() {
    return (
      <AboutSection
        ...
        setIsDefaultClient={setIsDefaultClient}
        stats={stats}
      />
    );
  }
